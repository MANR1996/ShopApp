        ...
        <div className="Footer">
            <div className="first-row">
                <div className="contact-us">
                    ...
                    <div className='phone'><PhoneIcon style={{ color: "#091625", width: '22px', height: '22px' }} /><span>+1-202-555-0129</span></div>
            ...
            <div className="second-row">
                ...
                <div className="region-language">
                    <div className='region'>Region: <span><svg width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
